(function() {
  ...
  function init(){
    ...
    wave['single_page'] = [];
    wave['single_page'][0] = new wave(1, 60, 50, 4, 0, 3, '#000000', 1024, 400);
    bg[0] = new background(1,'#b19cd9','#3498db',.3,12,1024,600);
    ...
    bg[1] = new background(2,'#000000','#3498db',.3,12,1024,600);
